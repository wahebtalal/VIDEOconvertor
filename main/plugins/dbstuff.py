...
from .. import heebow, AUTH_USERS, MONGODB_URI
...
@heebow.on(events.NewMessage(incoming=True, from_users=AUTH_USERS , pattern="/users"))
...
@heebow.on(events.NewMessage(incoming=True, from_users=AUTH_USERS , pattern="/bcast"))
...
@heebow.on(events.NewMessage(incoming=True, from_users=AUTH_USERS , pattern="^/disallow (.*)" ))
...
@heebow.on(events.NewMessage(incoming=True, from_users=AUTH_USERS , pattern="^/allow (.*)" ))
